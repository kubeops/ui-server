...
func schema_ui_server_apis_identity_v1alpha1_UserInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_ui_server_apis_identity_v1alpha1_WhoAmI(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"response": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("kubeops.dev/ui-server/apis/identity/v1alpha1.WhoAmIResponse"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kubeops.dev/ui-server/apis/identity/v1alpha1.WhoAmIResponse"},
	}
}

func schema_ui_server_apis_identity_v1alpha1_WhoAmIResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"user": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("kubeops.dev/ui-server/apis/identity/v1alpha1.UserInfo"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kubeops.dev/ui-server/apis/identity/v1alpha1.UserInfo"},
	}
}
