...
import (
	...
	wardle "kubeshield.dev/whoami/apis/wardle"
...
func autoConvert_v1alpha1_FlunderSpec_To_wardle_FlunderSpec(in *FlunderSpec, out *wardle.FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (*kubeshield.dev/whoami/apis/wardle/v1alpha1.ReferenceType vs kubeshield.dev/whoami/apis/wardle.ReferenceType)
	return nil
}
...
func autoConvert_wardle_FlunderSpec_To_v1alpha1_FlunderSpec(in *wardle.FlunderSpec, out *FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (kubeshield.dev/whoami/apis/wardle.ReferenceType vs *kubeshield.dev/whoami/apis/wardle/v1alpha1.ReferenceType)
	return nil
}
