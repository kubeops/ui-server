...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in Violations) DeepCopyInto(out *Violations) {
	{
		in := &in
		*out = make(Violations, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Violations.
func (in Violations) DeepCopy() Violations {
	if in == nil {
		return nil
	}
	out := new(Violations)
