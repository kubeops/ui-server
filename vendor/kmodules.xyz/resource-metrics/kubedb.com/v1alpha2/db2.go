...
func init() {
	api.Register(schema.GroupVersionKind{
		...
		Version: "v1alpha2",
		Kind:    "DB2",
	}, DB2{}.ResourceCalculator())
}

type DB2 struct{}

func (r DB2) ResourceCalculator() api.ResourceCalculator {
...
func (r DB2) roleReplicasFn(obj map[string]any) (api.ReplicaList, error) {
...
func (r DB2) modeFn(obj map[string]any) (string, error) {
...
func (r DB2) usesTLSFn(obj map[string]any) (bool, error) {
	_, found, err := unstructured.NestedFieldNoCopy(obj, "spec", "tls")
	return found, err
}

func (r DB2) roleResourceFn(fn func(rr core.ResourceRequirements) core.ResourceList) func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
	return func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
		container, replicas, err := api.AppNodeResourcesV2(obj, fn, DB2ContainerName, "spec")
		if err != nil {
			return nil, err
		}
		...
		if replicas > 1 {
			sidecar, err := api.SidecarNodeResourcesV2(obj, fn, DB2SidecarContainerName, "spec")
			if err != nil {
				return nil, err
			}
