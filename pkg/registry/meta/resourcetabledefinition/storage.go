...
func NewStorage() *Storage {
	return &Storage{
		convertor: rest.NewDefaultTableConvertor(schema.GroupResource{
			...
			Resource: v1alpha1.ResourceResourceTableDefinitions,
		}),
	}
}

func (r *Storage) GroupVersionKind(_ schema.GroupVersion) schema.GroupVersionKind {
	return v1alpha1.SchemeGroupVersion.WithKind(v1alpha1.ResourceKindResourceTableDefinition)
}
...
func (r *Storage) New() runtime.Object {
	return &v1alpha1.ResourceTableDefinition{}
}

func (r *Storage) Get(ctx context.Context, name string, options *metav1.GetOptions) (runtime.Object, error) {
	obj, err := tabledefs.LoadByName(name)
	if err != nil {
		return nil, kerr.NewNotFound(schema.GroupResource{Group: meta.GroupName, Resource: v1alpha1.ResourceKindResourceTableDefinition}, name)
	}
	return obj, err
}
...
func (r *Storage) NewList() runtime.Object {
	return &v1alpha1.ResourceTableDefinitionList{}
}
...
func (r *Storage) List(ctx context.Context, options *metainternalversion.ListOptions) (runtime.Object, error) {
	...
	items := make([]v1alpha1.ResourceTableDefinition, 0, len(objs))
	...
	return &v1alpha1.ResourceTableDefinitionList{Items: items}, nil
}
