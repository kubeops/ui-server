...
require (
	...
	kmodules.xyz/resource-metadata v0.18.11-0.20240730064307-bacf71a2284b
...
replace github.com/open-policy-agent/gatekeeper/v3 => github.com/cloudnative-policy-agent/gatekeeper/v3 v3.16.1-0.20240519081305-723b96b477d8
